	...
	public BankSystem() {
		...
		btnUpdateAccount.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BankSystem.login(false);
				BankSystem.depositAndWithdrawButtons(true, "d");
		...
		btnDeposit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (btnDeposit.getText().equals("Deposit")) {
						...
						String msg = dao.credit(id, amount);
						BankSystem.depositAndWithdrawButtons(true, "d");
						...
						String msg = dao.debit(id, amount);
						BankSystem.depositAndWithdrawButtons(true, "w");
						lblTryAgain.setText(msg);
						lblTryAgain.setFont(new Font("Tahoma", Font.BOLD, 18));
		...
		btnDeleteAccount.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				btnBack.setVisible(true);
				BankSystem.login(false);
				BankSystem.checkAndDeleteButtons(true, "d");
			}
		});
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (btnDelete.getText().equals("Delete")) {
						...
						BankSystem.checkAndDeleteButtons(true, "c");
		...
		btnAllAccounts.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				BankSystem.login(false);
			try {
					ResultSet result = dao.getAccounts();
		...
		btnCreateAccount.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				btnBack.setVisible(true);
				BankSystem.login(false);
				BankSystem.createAccountButtons(true);
		...
		btnConnect.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				dao = new AccountsDAOImpl(username, password);
				if (AccountsDAOImpl.getConnection() != null) {
					BankSystem.login(true);
					BankSystem.hideLoginButtons(false);
				} else if (AccountsDAOImpl.getConnection() == null) {
					lblTryAgain.setForeground(Color.RED);
		...
		JLabel lblAbcBank = new JLabel("XYZ BANK");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Double balance = Double.parseDouble(textField_2.getText());
					...
					String msg = dao.createAcc(id, name, balance);
					BankSystem.createAccountButtons(true);
					lblTryAgain.setText(msg);
					lblTryAgain.setFont(new Font("Tahoma", Font.BOLD, 18));
		...
		btnLogout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				BankSystem.login(false);
				BankSystem.hideLoginButtons(false);
				BankSystem.createAccountButtons(false);
				BankSystem.checkAndDeleteButtons(false, "a");
				BankSystem.depositAndWithdrawButtons(false, "a");
				BankSystem.loginButtons(true);
			}
		});
